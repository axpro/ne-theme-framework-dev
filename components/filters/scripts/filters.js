...
$filters.once('filters',function(){var throbber='<div class="ajax-progress ajax-progress-throbber"><i class="icon icon--spinner is-spinning"></i></div>';$(document).ajaxStart(function(e){if(e.currentTarget.activeElement.form=='undefined'&&e.currentTarget.activeElement.form.id===filtersFormId){$itemsNumber.prepend(throbber);}});if(typeof enquire!=='undefined'){ // Runs on device width change.
enquire.register('screen and (min-width: 992px)',{ // Desktop.
match:function(){var $filtersWrapper=$(".filters__wrapper");$filtersSubmit.addClass('ctools-auto-submit-click'); // Opening filters when changing to desktop.
